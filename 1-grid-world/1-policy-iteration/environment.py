...
class GraphicDisplay(tk.Tk):
    ...
    def load_images(self):
        up = PhotoImage(Image.open("/Users/raghavendrans/Documents/Raghav's /University of Illinois/Spring - 2023/AE 598 - Reinforcement Learning/reinforcement-learning/1-grid-world/img/up.png").resize((13, 13)))
        right = PhotoImage(Image.open("/Users/raghavendrans/Documents/Raghav's /University of Illinois/Spring - 2023/AE 598 - Reinforcement Learning/reinforcement-learning/1-grid-world/img/right.png").resize((13, 13)))
        left = PhotoImage(Image.open("/Users/raghavendrans/Documents/Raghav's /University of Illinois/Spring - 2023/AE 598 - Reinforcement Learning/reinforcement-learning/1-grid-world/img/left.png").resize((13, 13)))
        down = PhotoImage(Image.open("/Users/raghavendrans/Documents/Raghav's /University of Illinois/Spring - 2023/AE 598 - Reinforcement Learning/reinforcement-learning/1-grid-world/img/down.png").resize((13, 13)))
        rectangle = PhotoImage(Image.open("/Users/raghavendrans/Documents/Raghav's /University of Illinois/Spring - 2023/AE 598 - Reinforcement Learning/reinforcement-learning/1-grid-world/img/rectangle.png").resize((65, 65)))
        triangle = PhotoImage(Image.open("/Users/raghavendrans/Documents/Raghav's /University of Illinois/Spring - 2023/AE 598 - Reinforcement Learning/reinforcement-learning/1-grid-world/img/triangle.png").resize((65, 65)))
        circle = PhotoImage(Image.open("/Users/raghavendrans/Documents/Raghav's /University of Illinois/Spring - 2023/AE 598 - Reinforcement Learning/reinforcement-learning/1-grid-world/img/circle.png").resize((65, 65)))
